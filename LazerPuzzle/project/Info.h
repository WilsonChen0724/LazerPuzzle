...
private:
    ButtonPair* navigationButtons;              // A ButtonPair variable (e.g., for navigation)
    LTexture* graph;                       // Array of LTexture objects for graphs     
    int currentPage;                           // Tracks the current page being displayed
